...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_unique_code', models.CharField(blank=True, max_length=10, null=True, unique=True)),
                ('referral_code', models.CharField(blank=True, max_length=10, null=True, unique=True)),
                ('used_referral_count', models.PositiveIntegerField(blank=True, default=0, null=True)),
